...
verification:
  ...
  - "`AGENTS.md`、docs/workflow/ROADMAP.md、docs/workflow/CONTRACTS.md、docs/workf\
    low/BASELINES.md、docs/workflow/STATUS.md、docs/workflow/DECISIONS.md 已建立首版骨架"
...
3. 按 `.workflow-system/FILE_SCHEMAS.md` 与 `templates/docs/` 的章节骨架建立首版 `.workflow-system/PROJECT_PROFILE.yaml`、`AGENTS.md`、`docs/workflow/ROADMAP.md`、`docs/workflow/CONTRACTS.md`、`docs/workflow/BASELINES.md`、`docs/workflow/STATUS.md`、`docs/workflow/DECISIONS.md`。
...
5. 生成 `AGENTS.md` 作为当前 workflow-system 的项目级宿主指引。已有 `CLAUDE.md` 属于目标项目自有文件，保持原样，不创建、不覆盖、不删除。

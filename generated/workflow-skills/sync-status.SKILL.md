...
version: 0.2.0
description: >
  Update STATUS.md to reflect actual project progress and stable boundaries
  after the task step finishes.
purpose: |
  更新 STATUS.md，反映当前项目整体进度和稳定状态。
stage: 阶段 7：状态同步
trigger: |
  任务阶段完成或状态发生变化时。
inputs:
